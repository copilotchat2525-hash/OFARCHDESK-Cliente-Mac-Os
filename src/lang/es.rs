...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "Estado"),
        ("Your Desktop", "OFARCH DESK - Soporte remoto"),
        ("desk_tip", "Comparte este número a tu técnico asignado para recibir asistencia"),
        ("Password", "Contraseña"),
        ("Ready", "Conexión Establecida"),
        ("Established", "Establecido"),
        ("connecting_status", "Conexión a la red OFARCHDESK en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que OFARCHDESK no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar OFARCHDESK a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a OFARCHDESK de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a OFARCHDESK de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que OFARCHDESK use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [OFARCHDESK Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep OFARCHDESK background service", "Dejar OFARCHDESK como Servicio en 2do plano"),
        ...
        ("Show OFARCHDESK", "Mostrar OFARCHDESK"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a OFARCHDESK permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a OFARCHDESK permisos de \"Grabar Audio\"."),
        ...
        ("verify_OFARCHDESK_password_tip", "Verificar la contraseña de OFARCHDESK"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses OFARCHDESK e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_OFARCHDESK_server_pro_to_{}_tip", "¡Por favor, actualiza OFARCHDESK Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que OFARCHDESK no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de OFARCHDESK"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de OFARCHDESK de fondo"),
        ...
        ("About OFARCHDESK", "Acerca de OFARCHDESK"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_OFARCHDESK_client_to_{}_tip", "Por favor, actualiza el cliente OFARCHDESK a la versión {} o superior en el lado remoto"),
